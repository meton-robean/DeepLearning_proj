...
sys.path.append('/home/cmt/coding_tests/DL_test/tf_simple_test/PTB_LSTM/rnn/ptb')
from rnn.ptb import reader

flags = tf.flags   #tf.flags type 
logging = tf.logging

flags.DEFINE_string(
    "model", "small",
    "A type of model. Possible options are: small, medium, large.")
flags.DEFINE_string("data_path", '/home/cmt/coding_tests/DL_test/tf_simple_test/PTB_LSTM/simple-examples/data', "data_path")
...
class PTBModel(object):
    ...
    def __init__(self, is_training, config):
        ...
        # 带权重的交叉熵计算
        #return  1D batch-sized float Tensor: The log-perplexity for each sequence
        ...
        self._final_state = state   #final state output
        ...
        self._train_op = optimizer.apply_gradients(zip(grads, tvars))  # 将梯度应用于变量 operation of grads update
...
def run_epoch(session, model, data, eval_op, verbose=False):
    ...
    for step, (x, y) in enumerate(reader.ptb_producer(data, model.batch_size,
                                                      model.num_steps)):
